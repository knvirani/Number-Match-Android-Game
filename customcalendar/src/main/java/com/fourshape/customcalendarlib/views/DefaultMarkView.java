...
public class DefaultMarkView extends BaseMarkView {
    ...
    private void initLayoutWithStyle(MarkStyle style){
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.date_text_view, null);
...
textView.setBackground(drawable);
            ...
            case MarkStyle.SELECTED_DATE:
                ...
                this.setPadding(11, 5, 11, 5);
                Drawable sDrawable = context.getDrawable(R.drawable.bg_selected_date_in_calendar);
