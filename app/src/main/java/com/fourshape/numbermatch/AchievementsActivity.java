...
import com.fourshape.numbermatch.page_adapters.AchievementsAdapter;
...
public class AchievementsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AchievementsAdapter achievementsAdapter = new AchievementsAdapter(this.getSupportFragmentManager(), getLifecycle(), tabLayout.getTabCount());

        viewPager.setAdapter(achievementsAdapter);
