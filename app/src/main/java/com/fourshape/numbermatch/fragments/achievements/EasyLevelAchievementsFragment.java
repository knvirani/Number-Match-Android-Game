...
public class EasyLevelAchievementsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        if (new SharedData(getContext()).getAchievementJson(GameLevel.EASY) == null) {
            achievement = new Achievement();
        } else {
            achievement = new Achievement(new Gson().fromJson(new SharedData(getContext()).getAchievementJson(GameLevel.EASY), Achievement.class));
        }
